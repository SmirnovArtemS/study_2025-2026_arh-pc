...
{\centering \includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{image/2.png}

}

\caption{Выгрузка с GitHub}

\end{figure}%

С помощью make создаем файлы report.pdf и report.docx и проверяем
корректность создания файлов в директории (рис3).

\begin{figure}

{\centering \includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{image/3.png}

}

\caption{Создание необходимых файлов и проверка их создания}

\end{figure}%

С помощью команды make clean удаляем созданные ранее файлы и проверяем
корректность выполнения команды(рис 3.4).
...
{\centering \includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{image/7.png}

}

\caption{Открываем report.qmd}
